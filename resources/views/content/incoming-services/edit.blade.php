<div class="modal fade" id="staticBackdrop{{$incomingService->id}}" data-bs-backdrop="static" data-bs-keyboard="false"
     tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{route('catalog.incoming-services.update',$incomingServices->id)}}" method="POST">
                @method('PATCH')
                @csrf
                <div id="formMain">
...
{{--                        </select>--}}
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="liter" class="form-control"
                               id="exampleFormControlInput1" value="{{$incomingService->percentage}}"
