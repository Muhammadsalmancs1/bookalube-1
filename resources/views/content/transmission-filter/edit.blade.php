<!-- Modal -->
<div class="modal fade" id="staticBackdrop{{ $transmissionFilter->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{route('catalog.transmission-filters.update',$transmissionFilter->id)}}" method="POST">
                @method('PATCH')
                @csrf
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="price" id="basic-default-fullname" placeholder="Edit Price"
                               value="{{$transmissionFilter->price}}" />
                    </div>
                </div>
