    ...
    <div class="container">
        <div class="row mt-4">
            <div class="col-lg-12 col-md-12 mx-auto d-flex align-items-center">
                <a href="{{route('dashboard')}}" class="main-btn-blank py-4 me-2 px-3" style="width: fit-content !important;">
                    <svg
                        ...
                        <ul class="settings-nav">
                            ...
                            <li class="">
                                <a href="{{route('referral.credit')}}">
                                    ...
                                    <svg width="24" height="25" class="me-2" viewBox="0 0 22 17" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <div class="col-lg-5 mt-lg-0 mt-4">
                        <form action="{{route('update.password')}}" method="POST">
                            ...
                            <div class="mb-3 lube-input">
                                <label for="id_password3" class="form-label">Enter Old Password</label>
                                <input type="password" name="old_password" class="form-control" id="id_password3" placeholder="*******">
                                <i class="far fa-eye" id="togglePassword3"></i>
                                <img src="{{asset('frontend/assets/images/password.svg')}}" alt="">
                            </div>
                            <div class="mb-3 lube-input">
                                <label for="id_password" class="form-label">Enter New Password</label>
                                <input type="password" name="new_password" class="form-control" id="id_password" placeholder="*******">
                                <i class="far fa-eye" id="togglePassword"></i>
                                <img src="{{asset('frontend/assets/images/password.svg')}}" alt="">
                            </div>
                            <div class="mb-3 lube-input">
                                <label for="id_password2" class="form-label">Confirm Password</label>
                                <input type="password" name="new_password_confirmation" class="form-control" id="id_password2" placeholder="*******">
